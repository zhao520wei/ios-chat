...
- (UINavigationController *)sliderNavigationController
{
    if (self.mainViewController) {
        ...
        } else if([self.mainViewController isKindOfClass:[WFCBaseTabBarController class]]) {
            WFCBaseTabBarController * tabbar = (WFCBaseTabBarController *)self.mainViewController;
            return tabbar.firstNav;
        }
